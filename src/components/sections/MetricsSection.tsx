            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-neutral-900/50 border border-neutral-800/50 rounded-2xl overflow-hidden shadow-2xl shadow-black/50">
                ...
                <div className="bg-[#050505] p-8 group hover:bg-[#0a0a0a] transition-all duration-300 relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-start mb-8 relative z-10">
                        <span className="text-[10px] mono-font uppercase text-emerald-500/70 tracking-widest border border-emerald-900/30 px-2 py-0.5 rounded bg-emerald-900/10">{t('metrics.uptime.label')}</span>
                        <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse shadow-[0_0_10px_#10b981]"></div>
                    </div>
                    <div className="text-4xl mono-font text-white mb-6 group-hover:text-emerald-200 transition-colors">{t('metrics.uptime.value')}</div>
                ...
                <div className="bg-[#050505] p-8 group hover:bg-[#0a0a0a] transition-all duration-300 relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-start mb-8 relative z-10">
                        <span className="text-[10px] mono-font uppercase text-indigo-500/70 tracking-widest border border-indigo-900/30 px-2 py-0.5 rounded bg-indigo-900/10">{t('metrics.latency.label')}</span>
                        <span className="text-[10px] text-neutral-600 mono-font">{t('metrics.latency.unit')}</span>
                    </div>
                    <div className="text-4xl mono-font text-white mb-6 group-hover:text-indigo-200 transition-colors">{t('metrics.latency.value')}</div>
                ...
                <div className="bg-[#050505] p-8 group hover:bg-[#0a0a0a] transition-all duration-300 relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-start mb-8 relative z-10">
                        <span className="text-[10px] mono-font uppercase text-cyan-500/70 tracking-widest border border-cyan-900/30 px-2 py-0.5 rounded bg-cyan-900/10">{t('metrics.commits.label')}</span>
                        <span className="text-[10px] text-neutral-600 mono-font">{t('metrics.commits.unit')}</span>
                    </div>
                    <div className="text-4xl mono-font text-white mb-6 group-hover:text-cyan-200 transition-colors">{t('metrics.commits.value')}</div>
                ...
                <div className="bg-[#050505] p-8 group hover:bg-[#0a0a0a] transition-all duration-300 relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-start mb-8 relative z-10">
                        <span className="text-[10px] mono-font uppercase text-rose-500/70 tracking-widest border border-rose-900/30 px-2 py-0.5 rounded bg-rose-900/10">{t('metrics.requests.label')}</span>
                        <span className="text-[10px] text-neutral-600 mono-font">{t('metrics.requests.unit')}</span>
                    </div>
                    <div className="text-4xl mono-font text-white mb-6 group-hover:text-rose-200 transition-colors">{t('metrics.requests.value')}</div>
