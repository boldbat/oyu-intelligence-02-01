      ...
      <div ref={containerRef} className="process-container flex flex-col md:flex-row h-auto md:h-full w-full md:w-[400vw]">
        ...
        <div className="w-full md:w-screen min-h-[70vh] md:h-full grid grid-cols-1 lg:grid-cols-2 border-b md:border-b-0 md:border-r border-neutral-800/50 relative bg-[#030303]">
          <div className="flex flex-col justify-center px-6 md:px-24 py-20 md:py-0 relative z-10 pointer-events-none">
            <div className="absolute top-8 left-6 md:top-12 md:left-12 text-xs mono-font text-indigo-500 mb-2">{t('process.phases.discovery.phase')}</div>
            <h3 className="text-5xl md:text-8xl font-semibold text-transparent bg-clip-text bg-gradient-to-b from-white to-neutral-600 mb-6 md:mb-8 heading-font">{t('process.phases.discovery.title')}</h3>
            <p className="text-lg md:text-2xl text-neutral-400 max-w-xl font-light leading-relaxed">
              {t('process.phases.discovery.description')}
            </p>
          </div>
        ...
        <div className="w-full md:w-screen min-h-[70vh] md:h-full grid grid-cols-1 lg:grid-cols-2 border-b md:border-b-0 md:border-r border-neutral-800/50 relative bg-[#030303]">
          <div className="flex flex-col justify-center px-6 md:px-24 py-20 md:py-0 relative z-10 pointer-events-none">
            <div className="absolute top-8 left-6 md:top-12 md:left-12 text-xs mono-font text-cyan-500 mb-2">{t('process.phases.architecture.phase')}</div>
            <h3 className="text-5xl md:text-8xl font-semibold text-transparent bg-clip-text bg-gradient-to-b from-white to-neutral-600 mb-6 md:mb-8 heading-font">{t('process.phases.architecture.title')}</h3>
            <p className="text-lg md:text-2xl text-neutral-400 max-w-xl font-light leading-relaxed">
              {t('process.phases.architecture.description')}
            </p>
          </div>
          <div className="hidden lg:flex items-center justify-center relative border-l border-neutral-800/50 overflow-hidden bg-neutral-900/20">
        ...
        <div className="w-full md:w-screen min-h-[70vh] md:h-full grid grid-cols-1 lg:grid-cols-2 border-b md:border-b-0 md:border-r border-neutral-800/50 relative bg-[#030303]">
          <div className="flex flex-col justify-center px-6 md:px-24 py-20 md:py-0 relative z-10 pointer-events-none">
            <div className="absolute top-8 left-6 md:top-12 md:left-12 text-xs mono-font text-purple-500 mb-2">{t('process.phases.development.phase')}</div>
            <h3 className="text-5xl md:text-8xl font-semibold text-transparent bg-clip-text bg-gradient-to-b from-white to-neutral-600 mb-6 md:mb-8 heading-font">{t('process.phases.development.title')}</h3>
            <p className="text-lg md:text-2xl text-neutral-400 max-w-xl font-light leading-relaxed">
              {t('process.phases.development.description')}
            </p>
          </div>
          <div className="hidden lg:flex items-center justify-center relative border-l border-neutral-800/50 overflow-hidden bg-neutral-900/20">
